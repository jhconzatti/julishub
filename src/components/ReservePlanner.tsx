  ...
  return <div className="mt-6 space-y-6">
    <div className="grid gap-6 lg:grid-cols-3">
      ...
      <div className="space-y-6 lg:col-span-2">{plan ? <>
        ...
        <DecisionGuidanceCard title={t("decisionGuidance.reserve.title")} points={[t("decisionGuidance.reserve.target"), t("decisionGuidance.reserve.horizon")]} disclaimer={t("decisionGuidance.reserve.disclaimer")} learnMore={t("decisionGuidance.learnMore")} href={lp(`/blog/${decisionGuidanceArticles.reserve}`)} />
